...
model = load_model("3/keras_model.h5", compile=False)

# Carregar as classes (Mais Volume - joinha pra cima - e Menos Volume - joinha pra baixo)
class_names = open("3/labels.txt", "r").readlines()
...
while True:
    ...
    # Adicionar texto de previsão de classe à imagem - OPCIONAL, apenas para aparecer no frame
